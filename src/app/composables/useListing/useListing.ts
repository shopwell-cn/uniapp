...
import type {operations, Schemas} from "@/app/composables/types/api-types";
import {getListingFilters} from "@/app/helpers";
...
export function createListingComposable({
  ...
  // this function sets the current filters as shortcut filters @see https://shopwell.stoplight.io/docs/store-api/b56ebe18277c6-searching-for-products#product-listing-criteria
